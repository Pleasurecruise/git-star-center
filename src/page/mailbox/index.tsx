...
const MailBox = () => {
    const {mails, getMails, account, getAccount, readMail, unreadMail, deleteMail, deleting} = useAccountStore()
                                ...
                                {mails.map((mail) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex justify-between items-center mt-2">
                                            ...
                                            {selectedMail?.id === mail.id && mail.hasRead ? (
                                                <MailOpen className="h-4 w-4 text-muted-foreground" onClick={() => {
                                                    unreadMail({id: mail.id});
                                                    mail.hasRead = false;
                                                }}/>
                                            ) : (
                                                <Mail className="h-4 w-4 text-blue-500" onClick={() => {
                                                    readMail({id: mail.id});
                                                    mail.hasRead = true;
                                                }}/>
                                            )}
