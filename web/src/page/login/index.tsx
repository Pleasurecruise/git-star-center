...
function Login() {
    return (
        <div className="min-h-screen flex flex-col justify-between">
                            ...
                            <BoxReveal boxColor={"#0EA5E9"} duration={0.5}>
                                <div className="mt-6">
                                    <p>
                                        ...
                                        <br />
                                        -&gt; <a href="https://github.com/Pleasurecruise/Git-Star-Center" className="text-blue-500 underline">项目地址</a>，你的 Star 是对我最大的支持！
                                    </p>
                                </div>
                            </BoxReveal>
                        </div>
            ...
            <footer className='text-center text-muted-foreground text-xs p-4'>
                <p>&copy; {currentYear} Git Star Center. All rights reserved. 前端风格参考 <a href="https://github.com/pipijoe/xryder-web" className="text-blue-500 underline">X.Ryder</a>。</p>
            </footer>
        </div>
    );
}
